...
**New Template:**
- Implementation: `cap/templates/{name}.md`
- Documentation: Template is self-documenting (includes guidelines)

**New Workflow:**
- Implementation: `cap/workflows/{name}.md`
- Usage: Reference from command with `@~/.claude/cap/workflows/{name}.md`

**New Reference Document:**
- Implementation: `cap/references/{name}.md`
