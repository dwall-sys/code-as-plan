...
<!-- For checkpoint task examples and patterns, see @~/.claude/cap/references/checkpoints.md -->
...
See `~/.claude/cap/references/tdd.md` for TDD plan structure.
...
See `~/.claude/cap/workflows/verify-phase.md` for verification logic.
