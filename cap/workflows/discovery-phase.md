...
See ~/.claude/cap/templates/discovery.md `<discovery_protocol>` for full protocol.
</source_hierarchy>
...
6. **Create DISCOVERY.md** using ~/.claude/cap/templates/discovery.md structure:
...
1. **Scope the discovery** using ~/.claude/cap/templates/discovery.md:
...
6. **Create comprehensive DISCOVERY.md:**
   ...
   - Full structure from ~/.claude/cap/templates/discovery.md
...
Use ~/.claude/cap/templates/discovery.md.
