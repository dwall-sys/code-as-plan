...
Resolve the model profile once at the start of orchestration, then use it for all Task spawns.
...
Look up the agent in the profile table for the resolved profile. Pass the model parameter to Task calls:
