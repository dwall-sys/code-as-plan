...
```bash
# Claude Code
npx cap-cc --claude --global
npx cap-cc --claude --local

# OpenCode
npx cap-cc --opencode --global

# Gemini CLI
npx cap-cc --gemini --global

# Codex
npx cap-cc --codex --global
npx cap-cc --codex --local

# Copilot
npx cap-cc --copilot --global
npx cap-cc --copilot --local

# Cursor
npx cap-cc --cursor --global
npx cap-cc --cursor --local

# Antigravity
npx cap-cc --antigravity --global
npx cap-cc --antigravity --local

# Todos
npx cap-cc --all --global
```
...
- Rode `/gsd:help`
- Reinstale com `npx cap-cc@latest`
...
OpenCode, Gemini CLI e Codex agora são suportados nativamente via `npx cap-cc`.
