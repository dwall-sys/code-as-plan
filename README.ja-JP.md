...
```bash
# Claude Code
npx cap-cc --claude --global   # ~/.claude/ にインストール
npx cap-cc --claude --local    # ./.claude/ にインストール

# OpenCode（オープンソース、無料モデル）
npx cap-cc --opencode --global # ~/.config/opencode/ にインストール

# Gemini CLI
npx cap-cc --gemini --global   # ~/.gemini/ にインストール

# Codex（スキルファースト）
npx cap-cc --codex --global    # ~/.codex/ にインストール
npx cap-cc --codex --local     # ./.codex/ にインストール

# Copilot（GitHub Copilot CLI）
npx cap-cc --copilot --global  # ~/.github/ にインストール
npx cap-cc --copilot --local   # ./.github/ にインストール

# Cursor CLI
npx cap-cc --cursor --global      # ~/.cursor/ にインストール
npx cap-cc --cursor --local       # ./.cursor/ にインストール

# Antigravity（Google、スキルファースト、Geminiベース）
npx cap-cc --antigravity --global # ~/.gemini/antigravity/ にインストール
npx cap-cc --antigravity --local  # ./.agent/ にインストール

# 全ランタイム
npx cap-cc --all --global      # すべてのディレクトリにインストール
```
...
- `npx cap-cc` を再実行して再インストールしてください
...
OpenCode、Gemini CLI、Codexは `npx cap-cc` でネイティブサポートされています。
