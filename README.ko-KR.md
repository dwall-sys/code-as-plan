...
```bash
# Claude Code
npx cap-cc --claude --global   # ~/.claude/에 설치
npx cap-cc --claude --local    # ./.claude/에 설치

# OpenCode (오픈소스, 무료 모델)
npx cap-cc --opencode --global # ~/.config/opencode/에 설치

# Gemini CLI
npx cap-cc --gemini --global   # ~/.gemini/에 설치

# Codex (스킬 우선)
npx cap-cc --codex --global    # ~/.codex/에 설치
npx cap-cc --codex --local     # ./.codex/에 설치

# Copilot (GitHub Copilot CLI)
npx cap-cc --copilot --global  # ~/.github/에 설치
npx cap-cc --copilot --local   # ./.github/에 설치

# Cursor CLI
npx cap-cc --cursor --global      # ~/.cursor/에 설치
npx cap-cc --cursor --local       # ./.cursor/에 설치

# Antigravity (Google, 스킬 우선, Gemini 기반)
npx cap-cc --antigravity --global # ~/.gemini/antigravity/에 설치
npx cap-cc --antigravity --local  # ./.agent/에 설치

# 전체 런타임
npx cap-cc --all --global      # 모든 디렉터리에 설치
```
...
OpenCode, Gemini CLI, Codex는 이제 `npx cap-cc`를 통해 기본 지원됩니다.
