...
| 워크플로우: new-workspace | `cap/workflows/new-workspace.md` |
| 워크플로우: list-workspaces | `cap/workflows/list-workspaces.md` |
| 워크플로우: remove-workspace | `cap/workflows/remove-workspace.md` |
| Init 함수 | `cap/bin/lib/init.cjs`(`cmdInitNewWorkspace`, `cmdInitListWorkspaces`, `cmdInitRemoveWorkspace` 추가) |
| 라우팅 | `cap/bin/gsd-tools.cjs`(init switch에 case 추가) |
