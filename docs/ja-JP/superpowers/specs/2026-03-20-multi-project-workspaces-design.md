...
| ワークフロー: new-workspace | `cap/workflows/new-workspace.md` |
| ワークフロー: list-workspaces | `cap/workflows/list-workspaces.md` |
| ワークフロー: remove-workspace | `cap/workflows/remove-workspace.md` |
| Init 関数 | `cap/bin/lib/init.cjs`（`cmdInitNewWorkspace`、`cmdInitListWorkspaces`、`cmdInitRemoveWorkspace` を追加） |
| ルーティング | `cap/bin/gsd-tools.cjs`（init switch にケースを追加） |
